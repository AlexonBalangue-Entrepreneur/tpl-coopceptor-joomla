...
<ul>
	<?php if ($grouped) : ?>
		...
		<li>
			<div><?php echo JText::_($group_name); ?></div>
			<ul>
				<?php foreach ($group as $item) : ?>
					<li>
						...
						<?php if ($item->displayHits) : ?>
							<span>(<?php echo $item->displayHits; ?>)</span>
						<?php endif; ?>
						...
						<?php if ($params->get('show_tags', 0) && $item->tags->itemTags) : ?>
							<div><?php echo JLayoutHelper::render('joomla.content.tags', $item->tags->itemTags); ?></div>
						<?php endif; ?>

						<?php if ($params->get('show_introtext')) : ?>
							<p class="text-center"><?php echo $item->displayIntrotext; ?></p>
						<?php endif; ?>
